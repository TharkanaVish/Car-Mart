...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(ConstantsC.CREATE_TABLE);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS "+ConstantsC.TABLE_NAME);
        onCreate(db);
    }
    ...
    public long insertACar(String brand, String Model, String transmission, String ModYear,String image, String mileage,
                           String fuel,String contact,String add_car,String update_car){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    //Update Car Details-IT19118246
    public void updateACar(String id,String brand, String Model, String transmission, String ModYear,String image, String mileage,
                           String fuel,String contact,String add_car,String update_car){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(ConstantsC.C_BRAND,brand);
    ...
    //Select and Retrieve Car Details-IT19118246
